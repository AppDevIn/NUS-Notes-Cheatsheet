...
public class Account {
  ...
  public Account deposit(double amount) {
    return new Account(this. accountNumber, this.balance + amount, this.owners);
  }
  ...
  public Pair<Account, Account> transferTo(Account toAccount, double amount) {
    ...
    Account acc = this.withdraw(amount);
    return new Pair<>(acc, toAccount);
  }
  ...
  public Account combine(Account other) {
    return new Account(this.accountNumber,
            ...
            concat(this.owners, other.owners)
    );
  }
  ...
  public Account close() {
    return new Account(this.accountNumber, this.balance, true, this.owners);
  }
